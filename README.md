...
## Data acquisition
There are two different data sources. In one hand, the module `/Bank_Holidays` contains a .csv file with all the bank holidays in Spain from 01/01/2014 to 01/01/2017.
